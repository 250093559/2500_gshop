						...
						<section class="shop_rating_order">
							<div class="shop_rating_order_left">
							    ...
							    <div class="star star-24">
									<div class="star-item on"></div>
									<div class="star-item on"></div>
									<div class="star-item on"></div>
									<div class="star-item half"></div>
									<div class="star-item off"></div>
								</div>	
							</div>
									
							<div class="shop_rating_order_right">
								<span class="delivery_style delivery_right">佛山专送</span>
							</div>
						</section>
